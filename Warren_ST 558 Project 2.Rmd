...
animate(animatedPlot, duration = length(unique(interestAndInflationRates$record_calendar_year)), fps = 20, width = 200, height = 200, renderer = gifski_renderer())
save_animation(animatedPlot, "animated_plot.gif")
```
